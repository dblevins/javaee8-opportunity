...
public interface SimpleUserRepository extends CrudRepository<User, Long> {
	...
	/**
	 * Returns all users with the given name as first- or lastname. Makes use of the {@link org.springframework.data.repository.query.Param} annotation to use named
